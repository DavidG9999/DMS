...
type UpdateAutoRequest struct {
	...
	AutoId      int64   `protobuf:"varint,1,opt,name=auto_id,json=autoId,proto3" json:"auto_id,omitempty"`                     // Auto ID.
	Brand       *string `protobuf:"bytes,2,opt,name=brand,proto3,oneof" json:"brand,omitempty"`                                // Auto Brand.
	Model       *string `protobuf:"bytes,3,opt,name=model,proto3,oneof" json:"model,omitempty"`                                // Auto Model.
	StateNumber *string `protobuf:"bytes,4,opt,name=state_number,json=stateNumber,proto3,oneof" json:"state_number,omitempty"` // Auto State number.
}
...
type UpdateContragentRequest struct {
	...
	ContragentId int64   `protobuf:"varint,1,opt,name=contragent_id,json=contragentId,proto3" json:"contragent_id,omitempty"` // Contragent ID.
	Name         *string `protobuf:"bytes,2,opt,name=name,proto3,oneof" json:"name,omitempty"`                                // Contragent Name.
	Address      *string `protobuf:"bytes,3,opt,name=address,proto3,oneof" json:"address,omitempty"`                          // Contragent Address.
	InnKpp       *string `protobuf:"bytes,4,opt,name=inn_kpp,json=innKpp,proto3,oneof" json:"inn_kpp,omitempty"`              // Contragent Inn/Kpp.
}
...
type UpdateDispetcherRequest struct {
	...
	DispetcherId int64   `protobuf:"varint,1,opt,name=dispetcher_id,json=dispetcherId,proto3" json:"dispetcher_id,omitempty"` // Dispetcher ID.
	FullName     *string `protobuf:"bytes,2,opt,name=full_name,json=fullName,proto3,oneof" json:"full_name,omitempty"`        // Dispetcher Name.
}
...
type UpdateMehanicRequest struct {
	...
	MehanicId int64   `protobuf:"varint,1,opt,name=mehanic_id,json=mehanicId,proto3" json:"mehanic_id,omitempty"`   // Mehanic ID.
	FullName  *string `protobuf:"bytes,2,opt,name=full_name,json=fullName,proto3,oneof" json:"full_name,omitempty"` // Mehanic Name.
}
...
type UpdateDriverRequest struct {
	...
	DriverId int64   `protobuf:"varint,1,opt,name=driver_id,json=driverId,proto3" json:"driver_id,omitempty"`      // Driver ID.
	FullName *string `protobuf:"bytes,2,opt,name=full_name,json=fullName,proto3,oneof" json:"full_name,omitempty"` // Driver name.
	License  *string `protobuf:"bytes,3,opt,name=license,proto3,oneof" json:"license,omitempty"`                   // Driver License.
	Class    *string `protobuf:"bytes,4,opt,name=class,proto3,oneof" json:"class,omitempty"`                       // Driver Class.
}
...
type UpdateOrganizationRequest struct {
	...
	OrganizationId int64   `protobuf:"varint,1,opt,name=organization_id,json=organizationId,proto3" json:"organization_id,omitempty"` // Organization ID.
	Name           *string `protobuf:"bytes,2,opt,name=name,proto3,oneof" json:"name,omitempty"`                                      // Organization Name.
	Address        *string `protobuf:"bytes,3,opt,name=address,proto3,oneof" json:"address,omitempty"`                                // Organization Address.
	Chief          *string `protobuf:"bytes,4,opt,name=chief,proto3,oneof" json:"chief,omitempty"`                                    // Organization Chief.
	FinChief       *string `protobuf:"bytes,5,opt,name=fin_chief,json=finChief,proto3,oneof" json:"fin_chief,omitempty"`              // Organization Financial Chief.
	InnKpp         *string `protobuf:"bytes,6,opt,name=inn_kpp,json=innKpp,proto3,oneof" json:"inn_kpp,omitempty"`                    // Organization Inn/Kpp.
}
...
type UpdateBankAccountRequest struct {
	...
	BankAccountId     int64   `protobuf:"varint,1,opt,name=bank_account_id,json=bankAccountId,proto3" json:"bank_account_id,omitempty"`                  // BankAccount ID.
	BankAccountNumber *string `protobuf:"bytes,2,opt,name=bank_account_number,json=bankAccountNumber,proto3,oneof" json:"bank_account_number,omitempty"` // BankAccount Account Name.
	BankName          *string `protobuf:"bytes,3,opt,name=bank_name,json=bankName,proto3,oneof" json:"bank_name,omitempty"`                              // BankAccount Bank Name.
	BankIdNumber      *string `protobuf:"bytes,4,opt,name=bank_id_number,json=bankIdNumber,proto3,oneof" json:"bank_id_number,omitempty"`                // BankAccount Bank Identity Number.
}
...
type PutlistEntity struct {
	...
	DateWith      string `protobuf:"bytes,5,opt,name=date_with,json=dateWith,proto3" json:"date_with,omitempty"`                   // Putlist Date With.
	DateFor       string `protobuf:"bytes,6,opt,name=date_for,json=dateFor,proto3" json:"date_for,omitempty"`                      // Putlist Date For.
...
func (x *PutlistEntity) GetDateWith() string {
	if x != nil {
		return x.DateWith
	}
	return ""
...
func (x *PutlistEntity) GetDateFor() string {
	if x != nil {
		return x.DateFor
	}
	return ""
...
type CreatePutlistRequest struct {
	...
	DateWith      string `protobuf:"bytes,4,opt,name=date_with,json=dateWith,proto3" json:"date_with,omitempty"`                   // Putlist Date With.
	DateFor       string `protobuf:"bytes,5,opt,name=date_for,json=dateFor,proto3" json:"date_for,omitempty"`                      // Putlist Date For.
...
func (x *CreatePutlistRequest) GetDateWith() string {
	if x != nil {
		return x.DateWith
	}
	return ""
...
func (x *CreatePutlistRequest) GetDateFor() string {
	if x != nil {
		return x.DateFor
	}
	return ""
...
type UpdatePutlistRequest struct {
	...
	UserId        int64   `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`                              // Putlist User ID.
	Number        int64   `protobuf:"varint,2,opt,name=number,proto3" json:"number,omitempty"`                                            // Putlist Number.
	BankAccountId *int64  `protobuf:"varint,3,opt,name=bank_account_id,json=bankAccountId,proto3,oneof" json:"bank_account_id,omitempty"` // Putlist BankAccount ID.
	DateWith      *string `protobuf:"bytes,4,opt,name=date_with,json=dateWith,proto3,oneof" json:"date_with,omitempty"`                   // Putlist Date With.
	DateFor       *string `protobuf:"bytes,5,opt,name=date_for,json=dateFor,proto3,oneof" json:"date_for,omitempty"`                      // Putlist Date For.
	AutoId        *int64  `protobuf:"varint,6,opt,name=auto_id,json=autoId,proto3,oneof" json:"auto_id,omitempty"`                        // Putlist Auto ID.
	DriverId      *int64  `protobuf:"varint,7,opt,name=driver_id,json=driverId,proto3,oneof" json:"driver_id,omitempty"`                  // Putlist Driver ID.
	DispetcherId  *int64  `protobuf:"varint,8,opt,name=dispetcher_id,json=dispetcherId,proto3,oneof" json:"dispetcher_id,omitempty"`      // Putlist Dispetcher ID.
	MehanicId     *int64  `protobuf:"varint,9,opt,name=mehanic_id,json=mehanicId,proto3,oneof" json:"mehanic_id,omitempty"`               // Putlist Mehanic ID.
}
...
func (x *UpdatePutlistRequest) GetDateWith() string {
	if x != nil && x.DateWith != nil {
		return *x.DateWith
	}
	return ""
}

func (x *UpdatePutlistRequest) GetDateFor() string {
	if x != nil && x.DateFor != nil {
		return *x.DateFor
	}
	return ""
}
...
type PutlistBodyEntity struct {
	...
	TimeWith      string `protobuf:"bytes,6,opt,name=time_with,json=timeWith,proto3" json:"time_with,omitempty"`                   // PutlistBody Time With.
	TimeFor       string `protobuf:"bytes,7,opt,name=time_for,json=timeFor,proto3" json:"time_for,omitempty"`                      // PutlistBody Time For.
}
...
func (x *PutlistBodyEntity) GetTimeWith() string {
	if x != nil {
		return x.TimeWith
	}
	return ""
...
func (x *PutlistBodyEntity) GetTimeFor() string {
	if x != nil {
		return x.TimeFor
	}
	return ""
...
type CreatePutlistBodyRequest struct {
	...
	TimeWith      string `protobuf:"bytes,5,opt,name=time_with,json=timeWith,proto3" json:"time_with,omitempty"`                 // PutlistBody Time With.
	TimeFor       string `protobuf:"bytes,6,opt,name=time_for,json=timeFor,proto3" json:"time_for,omitempty"`                    // PutlistBody Time For.
}
...
func (x *CreatePutlistBodyRequest) GetTimeWith() string {
	if x != nil {
		return x.TimeWith
	}
	return ""
...
func (x *CreatePutlistBodyRequest) GetTimeFor() string {
	if x != nil {
		return x.TimeFor
	}
	return ""
...
type UpdatePutlistBodyRequest struct {
	...
	PutlistBodyId int64   `protobuf:"varint,1,opt,name=putlist_body_id,json=putlistBodyId,proto3" json:"putlist_body_id,omitempty"`  // PutlistBody ID.
	Number        *int64  `protobuf:"varint,2,opt,name=number,proto3,oneof" json:"number,omitempty"`                                 // PutlistBody Number.
	ContragentId  *int64  `protobuf:"varint,3,opt,name=contragent_id,json=contragentId,proto3,oneof" json:"contragent_id,omitempty"` // PutlistBody Contragent ID.
	Item          *string `protobuf:"bytes,4,opt,name=item,proto3,oneof" json:"item,omitempty"`                                      // PutlistBody Item.
	TimeWith      *string `protobuf:"bytes,5,opt,name=time_with,json=timeWith,proto3,oneof" json:"time_with,omitempty"`              // PutlistBody Time With.
	TimeFor       *string `protobuf:"bytes,6,opt,name=time_for,json=timeFor,proto3,oneof" json:"time_for,omitempty"`                 // PutlistBody Time For.
}
...
func (x *UpdatePutlistBodyRequest) GetTimeWith() string {
	if x != nil && x.TimeWith != nil {
		return *x.TimeWith
	}
	return ""
}

func (x *UpdatePutlistBodyRequest) GetTimeFor() string {
	if x != nil && x.TimeFor != nil {
		return *x.TimeFor
	}
	return ""
}
...
var file_document_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x64, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0x74, 0x0a, 0x0a, 0x41, 0x75,
	0x74, 0x6f, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x17, 0x0a, 0x07, 0x61, 0x75, 0x74, 0x6f,
	0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x61, 0x75, 0x74, 0x6f, 0x49,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x12, 0x21, 0x0a,
	0x0c, 0x73, 0x74, 0x61, 0x74, 0x65, 0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x0b, 0x73, 0x74, 0x61, 0x74, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72,
	0x22, 0x62, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x75, 0x74, 0x6f, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x62, 0x72, 0x61, 0x6e, 0x64, 0x18, 0x01,
	...
	,
	...
	,
	...
	0x07, 0x69, 0x6e, 0x6e, 0x5f, 0x6b, 0x70, 0x70, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06,
	0x69, 0x6e, 0x6e, 0x4b, 0x70, 0x70, 0x22, 0x60, 0x0a, 0x17, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	,
	...
	0x6f, 0x6e, 0x74, 0x72, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x17, 0x0a, 0x04, 0x6e,
	...
	,
	...
	,
	...
	,
	...
	0x01, 0x28, 0x03, 0x52, 0x08, 0x64, 0x72, 0x69, 0x76, 0x65, 0x72, 0x49, 0x64, 0x22, 0x13, 0x0a,
	0x11, 0x47, 0x65, 0x74, 0x44, 0x72, 0x69, 0x76, 0x65, 0x72, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x22, 0x46, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x44, 0x72, 0x69, 0x76, 0x65, 0x72, 0x73,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x30, 0x0a, 0x07, 0x64, 0x72, 0x69, 0x76,
	0x65, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x64, 0x6f, 0x63, 0x75,
	0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x44, 0x72, 0x69, 0x76, 0x65, 0x72, 0x45, 0x6e, 0x74, 0x69, 0x74,
	0x79, 0x52, 0x07, 0x64, 0x72, 0x69, 0x76, 0x65, 0x72, 0x73, 0x22, 0xb2, 0x01, 0x0a, 0x13, 0x55,
	...
	,
	...
	0x76, 0x65, 0x72, 0x49, 0x64, 0x22, 0x30, 0x0a, 0x14, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x44,
	0x72, 0x69, 0x76, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x18, 0x0a,
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07,
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xb7, 0x01, 0x0a, 0x12, 0x4f, 0x72, 0x67, 0x61,
	0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x27,
	...
	0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x68, 0x69, 0x65, 0x66, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x63, 0x68, 0x69, 0x65, 0x66, 0x12, 0x1b, 0x0a, 0x09, 0x66,
	0x69, 0x6e, 0x5f, 0x63, 0x68, 0x69, 0x65, 0x66, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08,
	0x66, 0x69, 0x6e, 0x43, 0x68, 0x69, 0x65, 0x66, 0x12, 0x17, 0x0a, 0x07, 0x69, 0x6e, 0x6e, 0x5f,
	0x6b, 0x70, 0x70, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x69, 0x6e, 0x6e, 0x4b, 0x70,
	0x70, 0x22, 0x95, 0x01, 0x0a, 0x19, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x67, 0x61,
	...
	0x05, 0x63, 0x68, 0x69, 0x65, 0x66, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x63, 0x68,
	0x69, 0x65, 0x66, 0x12, 0x1b, 0x0a, 0x09, 0x66, 0x69, 0x6e, 0x5f, 0x63, 0x68, 0x69, 0x65, 0x66,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x66, 0x69, 0x6e, 0x43, 0x68, 0x69, 0x65, 0x66,
	0x12, 0x17, 0x0a, 0x07, 0x69, 0x6e, 0x6e, 0x5f, 0x6b, 0x70, 0x70, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x06, 0x69, 0x6e, 0x6e, 0x4b, 0x70, 0x70, 0x22, 0x45, 0x0a, 0x1a, 0x43, 0x72, 0x65,
	...
	,
	...
	,
	...
	0x62, 0x61, 0x6e, 0x6b, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x22, 0xfd, 0x01, 0x0a,
	...
	,
	...
	0x61, 0x67, 0x65, 0x22, 0x42, 0x0a, 0x18, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x42, 0x61, 0x6e,
	...
	,
	...
	0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x62, 0x61, 0x6e, 0x6b, 0x41,
	0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x64, 0x61, 0x74, 0x65,
	0x5f, 0x77, 0x69, 0x74, 0x68, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x64, 0x61, 0x74,
	0x65, 0x57, 0x69, 0x74, 0x68, 0x12, 0x19, 0x0a, 0x08, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x66, 0x6f,
	0x72, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x64, 0x61, 0x74, 0x65, 0x46, 0x6f, 0x72,
	...
	0x09, 0x6d, 0x65, 0x68, 0x61, 0x6e, 0x69, 0x63, 0x49, 0x64, 0x22, 0xa1, 0x02, 0x0a, 0x14, 0x43,
	...
	,
	...
	,
	...
	,
	...
	0x72, 0x69, 0x76, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4d, 0x0a,
	0x0c, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x44, 0x72, 0x69, 0x76, 0x65, 0x72, 0x12, 0x1d, 0x2e,
	...
	0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x44, 0x72,
	0x69, 0x76, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x8c, 0x03, 0x0a,
	0x0c, 0x4f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x5f, 0x0a,
	0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x12, 0x23, 0x2e, 0x64, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x43,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x24, 0x2e, 0x64, 0x6f, 0x63, 0x75, 0x6d,
	...
	0x6e, 0x73, 0x12, 0x21, 0x2e, 0x64, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x47, 0x65,
	...
	0x23, 0x2e, 0x64, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x4f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x24, 0x2e, 0x64, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x2e,
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5f, 0x0a, 0x12, 0x44, 0x65,
	0x6c, 0x65, 0x74, 0x65, 0x4f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x12, 0x23, 0x2e, 0x64, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x44, 0x65, 0x6c, 0x65,
	...
	0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xff, 0x02, 0x0a, 0x0b,
	0x42, 0x61, 0x6e, 0x6b, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x5c, 0x0a, 0x11, 0x43,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x42, 0x61, 0x6e, 0x6b, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x12, 0x22, 0x2e, 0x64, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x43, 0x72, 0x65, 0x61,
	0x74, 0x65, 0x42, 0x61, 0x6e, 0x6b, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x23, 0x2e, 0x64, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x2e,
	...
	,
	...
	,
...
var file_document_proto_depIdxs = []int32{
	...
	63, // 7: document.GetPutlistByNumberResponse.putlist:type_name -> document.PutlistEntity
	63, // 8: document.GetPutlistsResponse.putlists:type_name -> document.PutlistEntity
	74, // 9: document.GetPutlistBodiesResponse.putlist_bodies:type_name -> document.PutlistBodyEntity
	1,  // 10: document.Auto.CreateAuto:input_type -> document.CreateAutoRequest
	3,  // 11: document.Auto.GetAutos:input_type -> document.GetAutosRequest
	5,  // 12: document.Auto.UpdateAuto:input_type -> document.UpdateAutoRequest
	7,  // 13: document.Auto.DeleteAuto:input_type -> document.DeleteAutoRequest
	10, // 14: document.Contragent.CreateContragent:input_type -> document.CreateContragentRequest
	12, // 15: document.Contragent.GetContragents:input_type -> document.GetContragentsRequest
	14, // 16: document.Contragent.UpdateContragent:input_type -> document.UpdateContragentRequest
	16, // 17: document.Contragent.DeleteContragent:input_type -> document.DeleteContragentRequest
	19, // 18: document.Dispetcher.CreateDispetcher:input_type -> document.CreateDispetcherRequest
	21, // 19: document.Dispetcher.GetDispetchers:input_type -> document.GetDispetchersRequest
	23, // 20: document.Dispetcher.UpdateDispetcher:input_type -> document.UpdateDispetcherRequest
	25, // 21: document.Dispetcher.DeleteDispetcher:input_type -> document.DeleteDispetcherRequest
	28, // 22: document.Mehanic.CreateMehanic:input_type -> document.CreateMehanicRequest
	30, // 23: document.Mehanic.GetMehanics:input_type -> document.GetMehanicsRequest
	32, // 24: document.Mehanic.UpdateMehanic:input_type -> document.UpdateMehanicRequest
	34, // 25: document.Mehanic.DeleteMehanic:input_type -> document.DeleteMehanicRequest
	37, // 26: document.Driver.CreateDriver:input_type -> document.CreateDriverRequest
	39, // 27: document.Driver.GetDrivers:input_type -> document.GetDriversRequest
	41, // 28: document.Driver.UpdateDriver:input_type -> document.UpdateDriverRequest
	43, // 29: document.Driver.DeleteDriver:input_type -> document.DeleteDriverRequest
	46, // 30: document.Organization.CreateOrganization:input_type -> document.CreateOrganizationRequest
	48, // 31: document.Organization.GetOrganizations:input_type -> document.GetOrganizationsRequest
	50, // 32: document.Organization.UpdateOrganization:input_type -> document.UpdateOrganizationRequest
	52, // 33: document.Organization.DeleteOrganization:input_type -> document.DeleteOrganizationRequest
	55, // 34: document.BankAccount.CreateBankAccount:input_type -> document.CreateBankAccountRequest
	57, // 35: document.BankAccount.GetBankAccounts:input_type -> document.GetBankAccountsRequest
	59, // 36: document.BankAccount.UpdateBankAccount:input_type -> document.UpdateBankAccountRequest
	61, // 37: document.BankAccount.DeleteBankAccount:input_type -> document.DeleteBankAccountRequest
	64, // 38: document.Putlist.CreatePutlist:input_type -> document.CreatePutlistRequest
	68, // 39: document.Putlist.GetPutlists:input_type -> document.GetPutlistsRequest
	66, // 40: document.Putlist.GetPutlistByNumber:input_type -> document.GetPutlistByNumberRequest
	70, // 41: document.Putlist.UpdatePutlist:input_type -> document.UpdatePutlistRequest
	72, // 42: document.Putlist.DeletePutlist:input_type -> document.DeletePutlistRequest
	75, // 43: document.PutlistBody.CreatePutlistBody:input_type -> document.CreatePutlistBodyRequest
	77, // 44: document.PutlistBody.GetPutlistBodies:input_type -> document.GetPutlistBodiesRequest
	79, // 45: document.PutlistBody.UpdatePutlistBody:input_type -> document.UpdatePutlistBodyRequest
	81, // 46: document.PutlistBody.DeletePutlistBody:input_type -> document.DeletePutlistBodyRequest
	2,  // 47: document.Auto.CreateAuto:output_type -> document.CreateAutoResponse
	4,  // 48: document.Auto.GetAutos:output_type -> document.GetAutosResponse
	6,  // 49: document.Auto.UpdateAuto:output_type -> document.UpdateAutoResponse
	8,  // 50: document.Auto.DeleteAuto:output_type -> document.DeleteAutoResponse
	11, // 51: document.Contragent.CreateContragent:output_type -> document.CreateContragentResponse
	13, // 52: document.Contragent.GetContragents:output_type -> document.GetContragentsResponse
	15, // 53: document.Contragent.UpdateContragent:output_type -> document.UpdateContragentResponse
	17, // 54: document.Contragent.DeleteContragent:output_type -> document.DeleteContragentResponse
	20, // 55: document.Dispetcher.CreateDispetcher:output_type -> document.CreateDispetcherResponse
	22, // 56: document.Dispetcher.GetDispetchers:output_type -> document.GetDispetchersResponse
	24, // 57: document.Dispetcher.UpdateDispetcher:output_type -> document.UpdateDispetcherResponse
	26, // 58: document.Dispetcher.DeleteDispetcher:output_type -> document.DeleteDispetcherResponse
	29, // 59: document.Mehanic.CreateMehanic:output_type -> document.CreateMehanicResponse
	31, // 60: document.Mehanic.GetMehanics:output_type -> document.GetMehanicsResponse
	33, // 61: document.Mehanic.UpdateMehanic:output_type -> document.UpdateMehanicResponse
	35, // 62: document.Mehanic.DeleteMehanic:output_type -> document.DeleteMehanicResponse
	38, // 63: document.Driver.CreateDriver:output_type -> document.CreateDriverResponse
	40, // 64: document.Driver.GetDrivers:output_type -> document.GetDriversResponse
	42, // 65: document.Driver.UpdateDriver:output_type -> document.UpdateDriverResponse
	44, // 66: document.Driver.DeleteDriver:output_type -> document.DeleteDriverResponse
	47, // 67: document.Organization.CreateOrganization:output_type -> document.CreateOrganizationResponse
	49, // 68: document.Organization.GetOrganizations:output_type -> document.GetOrganizationsResponse
	51, // 69: document.Organization.UpdateOrganization:output_type -> document.UpdateOrganizationResponse
	53, // 70: document.Organization.DeleteOrganization:output_type -> document.DeleteOrganizationResponse
	56, // 71: document.BankAccount.CreateBankAccount:output_type -> document.CreateBankAccountResponse
	58, // 72: document.BankAccount.GetBankAccounts:output_type -> document.GetBankAccountsResponse
	60, // 73: document.BankAccount.UpdateBankAccount:output_type -> document.UpdateBankAccountResponse
	62, // 74: document.BankAccount.DeleteBankAccount:output_type -> document.DeleteBankAccountResponse
	65, // 75: document.Putlist.CreatePutlist:output_type -> document.CreatePutlistResponse
	69, // 76: document.Putlist.GetPutlists:output_type -> document.GetPutlistsResponse
	67, // 77: document.Putlist.GetPutlistByNumber:output_type -> document.GetPutlistByNumberResponse
	71, // 78: document.Putlist.UpdatePutlist:output_type -> document.UpdatePutlistResponse
	73, // 79: document.Putlist.DeletePutlist:output_type -> document.DeletePutlistResponse
	76, // 80: document.PutlistBody.CreatePutlistBody:output_type -> document.CreatePutlistBodyResponse
	78, // 81: document.PutlistBody.GetPutlistBodies:output_type -> document.GetPutlistBodiesResponse
	80, // 82: document.PutlistBody.UpdatePutlistBody:output_type -> document.UpdatePutlistBodyResponse
	82, // 83: document.PutlistBody.DeletePutlistBody:output_type -> document.DeletePutlistBodyResponse
...
func file_document_proto_init() {
	...
	file_document_proto_msgTypes[23].OneofWrappers = []any{}
	file_document_proto_msgTypes[32].OneofWrappers = []any{}
	file_document_proto_msgTypes[41].OneofWrappers = []any{}
	file_document_proto_msgTypes[50].OneofWrappers = []any{}
	file_document_proto_msgTypes[59].OneofWrappers = []any{}
	file_document_proto_msgTypes[70].OneofWrappers = []any{}
	file_document_proto_msgTypes[79].OneofWrappers = []any{}
	type x struct{}
